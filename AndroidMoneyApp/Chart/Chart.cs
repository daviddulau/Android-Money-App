...
namespace ManyManager
{
    public abstract class Chart
    {
        ...
        public float LabelTextSize { get; set; } = 15;

        /// <summary>
        /// Gets or sets the color of the chart background.
        /// </summary>
        /// <value>The color of the background.</value>
        public SKColor BackgroundColor { get; set; } = Globals.background;
		...
		public Line[] SplitLines(string text, SKPaint paint, float maxWidth)
		{
