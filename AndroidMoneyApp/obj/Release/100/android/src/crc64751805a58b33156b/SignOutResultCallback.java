...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ManyManager.SignOutResultCallback, ManyManager", SignOutResultCallback.class, __md_methods);
	}
	...
	public SignOutResultCallback ()
	{
		...
		if (getClass () == SignOutResultCallback.class)
			mono.android.TypeManager.Activate ("ManyManager.SignOutResultCallback, ManyManager", "", this, new java.lang.Object[] {  });
	}
