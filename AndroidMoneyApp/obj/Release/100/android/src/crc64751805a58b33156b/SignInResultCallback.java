...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ManyManager.SignInResultCallback, ManyManager", SignInResultCallback.class, __md_methods);
	}
	...
	public SignInResultCallback ()
	{
		...
		if (getClass () == SignInResultCallback.class)
			mono.android.TypeManager.Activate ("ManyManager.SignInResultCallback, ManyManager", "", this, new java.lang.Object[] {  });
	}
