...
public class MonthlyTransactionsReportAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ManyManager.MonthlyTransactionsReportAdapter, ManyManager", MonthlyTransactionsReportAdapter.class, __md_methods);
	}


	public MonthlyTransactionsReportAdapter ()
	{
		super ();
		if (getClass () == MonthlyTransactionsReportAdapter.class)
			mono.android.TypeManager.Activate ("ManyManager.MonthlyTransactionsReportAdapter, ManyManager", "", this, new java.lang.Object[] {  });
	}
